 ...
 * hu.bin@msn.com
 */
public class Ipptt extends MIDlet {
    ...
    public void startApp() {
        ...
        Canvas canvas = new Canvas() { // anonymous class
            ...
            //
            private Image[] allDeckImgIntArr = new Image[49];
            private Image imageHolder;
            //
            private int[] deckOne2Six = new int[48 * 6];
            private int[] levelGoodArr = new int[12];
            private int[] levelCommArr = new int[12];
            private int[] levelBadArr = new int[12];
            private int[] outCardsArr = new int[12];
            //
            ...
            public void paint(Graphics graphics) {
                ...
                if (isDownCardShow) {
                    ...
                    for (int i = 0; i < 48; i++) {
                        ...
                        tmpInt = tmpInt % 48 == 0 ? 48 : tmpInt % 48;
                        graphics.drawImage(allDeckImgIntArr[tmpInt], 14 + (i % 12) * 18, 228 + (i / 12) * 22, 0);
                    }
                }
                ...
                if (isOutCardShow) {
                    ...
                    for (int i = 0; i < deckOne2SixIdx; i++) {
                        ...
                        tmpInt = tmpInt % 12 == 0 ? 12 : tmpInt % 12;
                        outCardsArr[tmpInt - 1]++;
                    }
                    sb.delete(0, sb.length());
                    int k =0;
                    for (int i = 0; i < 12; i++) {
                        sb.append(outCardsArr[i]);
                        sb.append(" ");
                        k ++;

                        if (k % 3 == 0 ) {
                            graphics.drawString(sb.toString(), leftOffSet, 100 + (k / 3) * 20, 0);
                            sb.delete(0, sb.length());
                        }
                    }
                }
...
//                    shuffleCard();
            ...
            private void shuffleCard() {
                int[] sortedCards = new int[48 * 6];
                int[] randomCards = new int[48 * 6];
            ...
            private int getOneCardFromDeck() {
                ...
                int result = deckOne2Six[deckOne2SixIdx++] % 48;
                return result == 0 ? 48 : result;
            }
